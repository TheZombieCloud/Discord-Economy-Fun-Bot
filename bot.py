...
async def on_message(message):
    ...
    if message.content.startswith('ec!'):
        if (len(message.content)==8 and message.content[3:8] == "start"):
            ...
            offensive = str(data_retrievea(userID, "odmg")).strip("[]")
            ...
            embed.add_field(name = "Balance", value = "Bits and Iron")
            embed.add_field(name = "Bits", value = balance[1:len(balance)-2] + " bits")
            embed.add_field(name = "Iron", value = iron[1:len(iron)-2] + " iron")
            embed.add_field(name = "Troops", value = "Your offensive and defensive damage")
            embed.add_field(name = "Offensive Damage", value = offensive[1:len(offensive)-2] + " offensive damage")
            embed.add_field(name = "Defensive Damage", value = defensive[1:len(defensive)-2] + " defensive damage")
            embed.add_field(name = "Income", value = "The amount of bits and iron you gain every minute you talk")
            embed.add_field(name = "Bits", value = gainBits[1:len(gainBits)-2] + " bits/minute")
            embed.add_field(name = "Iron", value = gainIron[1:len(gainIron)-2] + " iron/minute")
            await channel.send(embed=embed)
